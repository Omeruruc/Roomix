...
import { Mail, Lock, LogIn, ArrowLeft, Sparkles, Zap } from 'lucide-react';
    ...
    try {
      ...
      if (error) {
        if (error.message.includes('Invalid login credentials')) {
          setFormError('Hatalı e-posta veya şifre');
        } else {
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 rounded-xl font-medium text-white bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 border border-white/10 relative overflow-hidden disabled:opacity-50"
            >
              <motion.div
